...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Main Channel ⭕️', url='https://t.me/BorutoAnime_Sub')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/BorutoAnime_Sub'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/BorutoAnime_Sub')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Main Channel', url='https://t.me/BorutoAnime_Sub'),
