...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/Funtastic_Movies"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/Funtastic_Movies")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/BorutoAnime_Sub'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/BorutoAnime_Sub')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/Funtastic_Movies')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Min Channel', url='https://t.me/BorutoAnime_Sub'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/Funtastic_Movies')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔥Movies Bot', url='https://t.me/Deadpool_pro_bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url=https://t.me/BorutoAnime_Sub/1'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/Funtastic_Movies")
    ])
